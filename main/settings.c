...
const setting_detail_t setting_detail[] = {
    ...
    {Setting_MinPos,               "MinPos",         Unit_mm,    Format_Int,   Format_Float, true,      false,    &settings.motion.pos.min,          &settings_defaults.motion.pos.min},
    {Setting_MaxPos,               "MaxPos",         Unit_mm,    Format_Int,   Format_Float, true,      false,    &settings.motion.pos.max,          &settings_defaults.motion.pos.max},
    {Setting_MinVel,               "MinVel",         Unit_mm_s,  Format_Int,   Format_Float, true,      false,    &settings.motion.vel.min,          &settings_defaults.motion.vel.min},
    {Setting_MaxVel,               "MaxVel",         Unit_mm_s,  Format_Int,   Format_Float, true,      false,    &settings.motion.vel.max,          &settings_defaults.motion.vel.max},
    {Setting_MinAcc,               "MinAcc",         Unit_mm_ss, Format_Int,   Format_Float, true,      false,    &settings.motion.acc.min,          &settings_defaults.motion.acc.min},
    {Setting_MaxAcc,               "MaxAcc",         Unit_mm_ss, Format_Int,   Format_Float, true,      false,    &settings.motion.acc.max,          &settings_defaults.motion.acc.max},
    ...
    {Setting_HomingFastVelocity,   "HomingFast",     Unit_mm_s,  Format_Int,   Format_Float, true,      false,    &settings.homing.fast_vel,         &settings_defaults.homing.fast_vel},
    {Setting_HomingSlowVelocity,   "HomingSlow",     Unit_mm_s,  Format_Int,   Format_Float, true,      false,    &settings.homing.slow_vel,         &settings_defaults.homing.slow_vel},
    {Setting_HomingRetractionDistance,"HRetraction", Unit_mm,    Format_Int,   Format_Float, true,      false,    &settings.homing.retraction,       &settings_defaults.homing.retraction},
